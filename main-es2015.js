...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div *ngIf=\"post\">\n<h2 [className]=\"'post'\"> {{post.title}}</h2>\n  <p [className]=\"'post'\">\n    <b>Created:</b> {{ post.created }}\n  </p>\n  <p *ngIf=\"post.archived\"><b>Archived</b></p>\n  <div>\n    <p>{{ post.body}}</p>\n  </div>\n  <app-comment></app-comment>\n</div>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/post-editor/post-editor.component.html":
/*!**********************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/post-editor/post-editor.component.html ***!
  \**********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\r\n<h2>Posts</h2>\r\n<div *ngFor=\"let post of posts\">\r\n\r\n  <h3 [className]=\"'post'\">\r\n    <a [title]=\"post.title + ' '\"\r\n       [routerLink]=\"['/posts', post.id]\"\r\n       >\r\n      {{ post.title }}\r\n    </a>\r\n  </h3>\r\n\r\n  <p [className]=\"'post'\">\r\n    <b>Created:</b> {{ post.created }}\r\n  </p>\r\n  <a *ngIf=\"!post.archived && this.authService.isLoggedIn\" [routerLink]=\"['/posts', post.id, 'edit']\">Edit</a>\r\n  <p [className]=\"'post'\" *ngIf=\"post.archived\">\r\n    <b>Archived</b>\r\n  </p>\r\n  <button (click)=\"this.blogPostService.deletePost(post.id)\" *ngIf=\"!post.archived && this.authService.isLoggedIn\">Archive</button>\r\n  <button (click)=\"this.blogPostService.unDeletePost(post.id)\" *ngIf=\"post.archived\">Unarchive</button>\r\n</div>\r\n<div *ngIf=\"this.posts.length === 0\">\r\n  <p>No posts found</p>\r\n</div>\r\n");
...
/* harmony import */ var _post_editor_post_editor_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./post-editor/post-editor.component */ "./src/app/post-editor/post-editor.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _post_editor_post_editor_component__WEBPACK_IMPORTED_MODULE_5__["PostEditorComponent"],
        ...
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"]
                .forRoot([
                { path: 'createPost', component: _post_editor_post_editor_component__WEBPACK_IMPORTED_MODULE_5__["PostEditorComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]], data: { kind: 'create' } },
                { path: 'posts/:postId', component: _post_details_post_details_component__WEBPACK_IMPORTED_MODULE_9__["PostDetailsComponent"] },
                { path: 'login', component: _auth_login_login_component__WEBPACK_IMPORTED_MODULE_11__["LoginComponent"] },
                { path: 'posts/:postId/edit', component: _post_editor_post_editor_component__WEBPACK_IMPORTED_MODULE_5__["PostEditorComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]], data: { kind: 'edit' } },
                { path: '', component: _post_list_post_list_component__WEBPACK_IMPORTED_MODULE_8__["PostListComponent"] },
            ])
        ],
        providers: [],
...
let AuthService = class AuthService {
    ...
    login(username, password) {
        ...
        return this.http.post('/api/login', formData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((res) => this.isLoggedIn = res, (err) => console.log(err)));
    }
    logout() {
        this.isLoggedIn = false;
    }
...
let BlogPostsService = class BlogPostsService {
    ...
    createPost(post) {
        this.http.post('/api/posts', post).subscribe((res) => console.log(res), (err) => console.log(err));
    }
    getPosts() {
        return this.http.get('/api/posts').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
            return res;
        }));
    }
    getPublicPosts() {
        return this.http.get('/api/posts?archived=false').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
            return res;
        }));
    }
    getPost(postId) {
        return this.http.get(`/api/posts/${postId}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
            return res;
        }));
    }
    deletePost(postId) {
        return this.http.delete(`/api/posts/${postId}`).subscribe((res) => console.log(res), (err) => console.log(err));
    }
    unDeletePost(postId) {
        return this.http.put(`/api/posts/${postId}?archived=false`, new FormData()).subscribe((res) => console.log(res), (err) => console.log(err));
    }
    updatePost(postId, title, body) {
        const formData = new FormData();
        formData.append('body', body);
        formData.append('title', title);
        this.http.put(`/api/posts/${postId}`, formData).subscribe((res) => console.log(res), (err) => console.log(err));
    }
    createComment(postId, comment) {
        const formData = new FormData();
        formData.append('body', comment);
        this.http.post(`/api/posts/${postId}/comments`, formData).subscribe((res) => console.log(res), (err) => console.log(err));
    }
    getComments(postId) {
        return this.http.get(`/api/posts/${postId}/comments`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
            return res;
        }));
    }
};
BlogPostsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let CommentComponent = class CommentComponent {
    constructor(formBuilder, route, blogPostService) {
        this.formBuilder = formBuilder;
        this.route = route;
    ...
    ngOnInit() {
        ...
        this.route.paramMap.subscribe(params => {
            ...
            this.blogPostService.getComments(this.postId).subscribe(data => {
                const time = moment__WEBPACK_IMPORTED_MODULE_3__(new Date(data.created).toString());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".post { display: inline}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _blog_posts_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../blog-posts.service */ "./src/app/blog-posts.service.ts");
...
let PostDetailsComponent = class PostDetailsComponent {
    constructor(route, blogPostService, router, authService) {
        this.route = route;
        this.blogPostService = blogPostService;
        this.router = router;
        this.authService = authService;
    ...
    ngOnInit() {
        this.route.paramMap.subscribe(params => {
            this.blogPostService.getPost(+params.get('postId')).subscribe(data => {
                const time = moment__WEBPACK_IMPORTED_MODULE_4__(new Date(data.created).toString());
                data.created = time.format('MMMM Do YYYY, h:mm:ss a');
...
PostDetailsComponent.ctorParameters = () => [
    ...
    { type: _blog_posts_service__WEBPACK_IMPORTED_MODULE_3__["BlogPostsService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
/***/ "./src/app/post-editor/post-editor.component.css":
/*!*******************************************************!*\
  !*** ./src/app/post-editor/post-editor.component.css ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Bvc3QtZWRpdG9yL3Bvc3QtZWRpdG9yLmNvbXBvbmVudC5jc3MifQ== */");
...
let PostEditorComponent = class PostEditorComponent {
    constructor(formBuilder, blogPostService, route, router) {
        this.formBuilder = formBuilder;
        this.blogPostService = blogPostService;
        this.route = route;
        this.router = router;
...
PostEditorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./post-editor.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/post-editor/post-editor.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./post-editor.component.css */ "./src/app/post-editor/post-editor.component.css")).default]
    })
], PostEditorComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (" .post { display: inline}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let PostListComponent = class PostListComponent {
    constructor(blogPostService, authService) {
        this.blogPostService = blogPostService;
        this.authService = authService;
        if (this.authService.isLoggedIn) {
    ...
    processPosts(posts) {
        posts.forEach((post) => {
            const time = moment__WEBPACK_IMPORTED_MODULE_2__(new Date(post.created).toISOString());
...
module.exports = __webpack_require__(/*! C:\Users\dylan\projects\Blog\frontend\src\main.ts */"./src/main.ts");
